...
let movies = [
  ...
  { id: 77, name: 'Vòng Quay Vô Cực', watched: true, year: 2012, cat: ['hk', 'hh'], rating: 4, poster: 'https://i.ibb.co/dSxyq5J/infinity-nado.png', note: 'Phim xoay quanh cuộc chiến của các con quay Nado, với nhân vật chính là Jin. Anh và bạn bè sử dụng những con quay có khả năng biến hình, kết hợp các yếu tố như đất, lửa, nước và gió để chiến đấu. Các trận đấu không chỉ là sự so tài về kỹ năng mà còn là cuộc chiến về tinh thần và chiến thuật.' },
  { id: 78, name: 'Robo Trái Cây', watched: true, year: 2010, cat: ['hk', 'hh'], rating: 4, poster: 'https://i.ibb.co/FqBRkbqP/robo-fruit.png', note: 'Với loạt nhân vật robot mang hình dạng của những trái cây quen thuộc như: Táo, Quýt, Thơm, Dừa, Măng Cụt, Dâu, Chuối... Robo Trái Cây nói về câu chuyện ly kỳ về Thế giới Trái Cây. Nơi đó những Robo trái cây biết bảo vệ lẽ phải, bảo vệ quê hương và đồng loại. Biết đoàn kết, yêu thương nhau tạo nên những sức mạnh siêu nhiên phi thường và đầy lòng quả cảm.' },
  ...
  { id: 80, name: 'Chiến Cơ Siêu Hạng', watched: true, year: 2010, cat: ['hk', 'hh'], rating: 5, poster: 'https://i.ibb.co/VW5kksjv/chien-co-sieu-hang.png', note: '' },
  { id: 81, name: 'Sấm Chớp Và Tốc Độ', watched: true, year: 2007, cat: ['hk', 'hh'], rating: 4, poster: 'https://i.ibb.co/20Pf1j8P/flash-and-dash.png', note: '' },
  { id: 82, name: 'Huyền Thoại Sân Cỏ CGO', watched: true, year: 2010, cat: ['hk', 'hh'], rating: 5, poster: 'https://i.ibb.co/G4FNN4NC/cgo.jpg', note: '' },
  { id: 83, name: 'Tuyệt Đỉnh YOYO', watched: true, year: 2006, cat: ['hk', 'hh'], rating: 4, poster: 'https://i.ibb.co/QFz8G7yR/yoyo.png', note: '' },
